...
def setup_database(con):
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS TASKS ( ID INTEGER PRIMARY KEY, TASKNAME VARCHAR(20), DESCRIPTION VARCHAR(100), STARTTIME VARCHAR(20), ENDTIME VARCHAR(20))")
    con.commit()  
